...
import { MainPageMetaProps } from "./type";

export const MainPageMeta: FunctionComponent<MainPageMetaProps> = ({ isMobile = false }) => {
  return (
    <Head>
      ...
      <meta property="og:url" content={isMobile ? GOCHO_MOBILE_URL : GOCHO_DESKTOP_URL} />
      <meta property="og:site_name" content="고초대졸닷컴 | 홈" />
      ...
      {!isMobile && <link rel="alternate" media="only screen and (max-width: 640px)" href={GOCHO_MOBILE_URL} />}
    </Head>
  );
};
