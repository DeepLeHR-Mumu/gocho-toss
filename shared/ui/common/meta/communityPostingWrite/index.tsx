...
import { CommunityPostingWriteMetaProps } from "./type";

export const CommunityPostingWriteMeta: FunctionComponent<CommunityPostingWriteMetaProps> = ({ isMobile = false }) => {
  return (
    <Head>
      ...
      <meta property="og:url" content={`${isMobile ? GOCHO_MOBILE_URL : GOCHO_DESKTOP_URL}/community/postings/write`} />
