...
export const CompanyRecruitMeta: FunctionComponent<CompanyRecruitMetaProps> = ({ option, isMobile = false }) => {
  ...
  return (
    <Head>
      ...
      <meta
        property="og:url"
        content={`${isMobile ? GOCHO_MOBILE_URL : GOCHO_DESKTOP_URL}/company/${option.id}/recruit`}
      />
