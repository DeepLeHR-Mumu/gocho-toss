...
import { MyPageMetaProps } from "./type";

export const MyPageMeta: FunctionComponent<MyPageMetaProps> = ({ isMobile = false }) => {
  return (
    <Head>
      <title>마이페이지 - 고초대졸닷컴</title>
      <meta name="description" content="" />
      <meta name="keywords" content="" />
      <meta property="og:title" content="" />
      <meta property="og:description" content="" />
      <meta property="og:type" content="website" />
      <meta property="og:url" content={`${isMobile ? GOCHO_MOBILE_URL : GOCHO_DESKTOP_URL}/mypage`} />
      <meta property="og:site_name" content="고초대졸닷컴 | 마이페이지" />
