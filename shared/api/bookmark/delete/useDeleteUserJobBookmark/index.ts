...
import { RequestObjDef, DeleteUserJobBookmark } from "./type";
...
const deleteUserJobBookmark: DeleteUserJobBookmark = async (requestObj) => {
...
export const useDeleteUserJobBookmarkArr = (jobObj: JobObjDef | undefined) => {
  const queryClient = useQueryClient();
  const mutationResult = useMutation<ResponseDef, AxiosError, RequestObjDef>(deleteUserJobBookmark, {
