  ...
  return (
    <section css={wrapper}>
      <header css={headerContainer}>
        <div css={flexBox}>
          <div css={iconBox}>
            <Image src={factoryIcon} alt="" layout="fill" objectFit="contain" />
          </div>
          <button
            type="button"
            css={factoryNameCSS}
      ...
      {isCardOpen && (
        <>
          <section css={menuContainer}>
            <div css={titleBox}>
              <div css={menuIconBox}>
                <Image src={locationIcon} alt="" layout="fill" objectFit="contain" />
              </div>
          ...
          <section css={menuContainer}>
            <div css={titleBox}>
              <div css={menuIconBox}>
                <Image src={productIcon} alt="" layout="fill" objectFit="contain" />
              </div>
          ...
          <section css={infoContainer}>
            <div css={contentBox}>
              <div css={menuIconBox}>
                <Image src={hireNumberIcon} alt="" layout="fill" objectFit="contain" />
              </div>
            ...
            <div css={contentBox}>
              <div css={menuIconBox}>
                <Image src={genderIcon} alt="" layout="fill" objectFit="contain" />
              </div>
              <p css={largeMenuNameBox}>
            ...
            <div css={contentBox}>
              <div css={menuIconBox}>
                <Image
                  src={factoryInfo.bus.exists ? busTrueIcon : busFalseIcon}
                  alt=""
                  layout="fill"
                  objectFit="contain"
                />
              ...
              <div css={xoBox}>
                <p>통근버스</p>
                <div css={xoIcons}>
                  <Image src={factoryInfo.bus.exists ? oIcon : xIcon} alt="" layout="fill" objectFit="contain" />
                </div>
              </div>
            ...
            <div css={contentBox}>
              <div css={menuIconBox}>
                <Image src={dormitoryIcon} alt="" layout="fill" objectFit="contain" />
              </div>
              <div css={xoBox}>
                <p>기숙사</p>
                <div css={xoIcons}>
