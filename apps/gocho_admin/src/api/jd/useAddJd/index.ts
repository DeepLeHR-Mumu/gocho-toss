        ...
        dto: {
          ...
          position_arr: requestObj.dto.position_arr.map((position) => ({
            ...
            place: {
              ...
              etc: position.place.etc === "" ? null : position.place.etc,
            },
