  ...
  <li css={factoryContainer}>
    ...
    <div css={inputContainer}>
      ...
      <label css={inputLabel} htmlFor={`버스유무${index}`}>
        <input type="checkbox" id={`버스유무${index}`} {...companyForm.register(`factory_arr.${index}.bus_bool`, {})} />
    ...
    <div css={inputContainer}>
      ...
      <label css={inputLabel} htmlFor={`기숙사유무${index}`}>
        ...
        <CheckBox isChecked={!companyForm.watch("factory_arr")[index].dormitory_bool} /> <p css={checkboxText}>없음</p>
      </label>
      <input
