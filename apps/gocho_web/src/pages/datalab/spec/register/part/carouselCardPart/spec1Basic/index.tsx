...
export const Spec1Basic: FunctionComponent<Spec1BasicProps> = ({
  moveNextCard,
}) => {
  const {
    handleSubmit,
  ...
  return (
    <div css={specCardWrapper}>
      <SpecCardTitle
        title={userInfoData.nickname}
        desc="간단하게 스펙 등록하고 평가를 받아보세요"
      />
      ...
      <form css={formCSS}>
        <ContainerBox optionObj={{ location: "bottom", marginValue: 1.7 }}>
          <div css={disabledWrapper}>
            <input
              css={inputTextCSS}
              defaultValue={userInfoData.nickname}
              readOnly
            />
        ...
        >
          ...
          {errors.gender?.message && (
            <WarningText msg={errors.gender.message} />
          )}
        </ContainerBox>
        ...
        <ContainerBox optionObj={{ location: "bottom", marginValue: 4 }}>
          ...
          {errors.military?.message && (
            <WarningText msg={errors.military.message} />
          )}
        </ContainerBox>

        <ContainerBox
          optionObj={{ location: "bottom", marginValue: 4, maxWidth: 52 }}
        >
          ...
          />
          {errors.desiredTask?.message && (
            <WarningText msg={errors.desiredTask.message} />
          )}
        </ContainerBox>
        ...
        />
        {errors.desiredIndustry?.message && (
          <WarningText msg={errors.desiredIndustry.message} />
        )}
