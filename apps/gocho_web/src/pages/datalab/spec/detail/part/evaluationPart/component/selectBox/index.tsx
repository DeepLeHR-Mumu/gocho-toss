...
import { backgroundCloseButton, closeButton, container, labelBox, labelDesc, wrapper } from "./style";
...
export const SelectBox: FunctionComponent<SelectBoxProps> = ({
  ...
  return (
    <>
      <button type="button" aria-hidden css={backgroundCloseButton} onClick={closeFunction} />
