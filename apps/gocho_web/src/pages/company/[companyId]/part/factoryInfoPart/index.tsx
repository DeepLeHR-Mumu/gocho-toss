            ...
            factory.id === activeFactory && (
              <div css={infoContainer} key={`companyFactoryDetailInfo${factory.id}`}>
                ...
                <div css={infoWrapper}>
                  <div css={productInfo}>
                    <div css={infoIcon}>
                      <Image fill sizes="1" src={productIcon} alt="공장 생산품 정보 아이콘" />
                    </div>
                    <div css={infoTextTop}>
                  ...
                  <div css={flexBox}>
                    <div css={infoChildBox}>
                      <div css={infoIcon}>
                        <Image fill sizes="1" src={hireNumberIcon} alt="공장 직원 정보 아이콘" />
                      </div>
                      <div css={infoText}>
                    ...
                    <div css={infoChildBox}>
                      <div css={infoIcon}>
                        <Image fill sizes="1" src={genderIcon} alt="공장 직원 성비 정보 아이콘" />
                      </div>
                      <div css={infoText}>
                    ...
                    <div css={infoChildBox}>
                      <div css={infoIcon}>
                        <Image fill sizes="1" src={dormitoryIcon} alt="공장 기숙사 정보 아이콘" />
                      </div>
                      <div css={infoText}>
