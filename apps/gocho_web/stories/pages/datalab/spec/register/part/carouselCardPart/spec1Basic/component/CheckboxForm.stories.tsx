...
import { CheckboxForm } from "@pages/datalab/spec/register/component/checkboxForm";
import { desiredIndustryArr } from "./mockData";

export default {
  title: "datalab/spec/register/part/carouselCardPart/Spec1Basic/component/CheckboxForm",
