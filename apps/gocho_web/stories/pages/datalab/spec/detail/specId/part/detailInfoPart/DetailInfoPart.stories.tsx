...
import { DetailInfoPart } from "@pages/datalab/spec/detail/part/detailInfoPart";
...
기본.args = {
  detailData: {
    ...
    etc: "저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다저는해커입니다",
  },
};
